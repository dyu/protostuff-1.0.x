// $ANTLR 3.2 Sep 23, 2009 14:05:07 com/dyuproject/protostuff/parser/ProtoParser.g 2016-05-20 23:56:53
...
public class ProtoParser extends AbstractParser {
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:61:1: statement[Proto proto] : ( header_syntax[proto] | header_package[proto] | header_import[proto] | message_block[proto, null] | enum_block[proto, null] | extend_block[proto, null] | service_block[proto, null] | annotation_entry[proto] | option_entry[proto, proto] );
    public final ProtoParser.statement_return statement(Proto proto) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:62:5: ( header_syntax[proto] | header_package[proto] | header_import[proto] | message_block[proto, null] | enum_block[proto, null] | extend_block[proto, null] | service_block[proto, null] | annotation_entry[proto] | option_entry[proto, proto] )
            int alt2=9;
            switch ( input.LA(1) ) {
            case SYNTAX:
                {
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:74:1: var_reserved : ( TO | PKG | SYNTAX | IMPORT | OPTION | MESSAGE | SERVICE | ENUM | REQUIRED | OPTIONAL | REPEATED | EXTENSIONS | EXTEND | GROUP | RPC | RETURNS | INT32 | INT64 | UINT32 | UINT64 | SINT32 | SINT64 | FIXED32 | FIXED64 | SFIXED32 | SFIXED64 | FLOAT | DOUBLE | BOOL | STRING | BYTES | DEFAULT | MAX | VOID );
    public final ProtoParser.var_reserved_return var_reserved() throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:75:5: ( TO | PKG | SYNTAX | IMPORT | OPTION | MESSAGE | SERVICE | ENUM | REQUIRED | OPTIONAL | REPEATED | EXTENSIONS | EXTEND | GROUP | RPC | RETURNS | INT32 | INT64 | UINT32 | UINT64 | SINT32 | SINT64 | FIXED32 | FIXED64 | SFIXED32 | SFIXED64 | FLOAT | DOUBLE | BOOL | STRING | BYTES | DEFAULT | MAX | VOID )
        ...
        try {
            ...
            switch (alt3) {
                case 1 :
                    ...
                    ID13=(Token)match(input,ID,FOLLOW_ID_in_var509); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
        ...
        try {
            ...
            switch (alt4) {
                case 1 :
                    ...
                    FULL_ID15=(Token)match(input,FULL_ID,FOLLOW_FULL_ID_in_var_full532); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
    ...
    public final ProtoParser.annotation_entry_return annotation_entry(Proto proto) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:94:5: ( AT var ( LEFTPAREN annotation_keyval[proto, annotation] ( COMMA annotation_keyval[proto, annotation] )* RIGHTPAREN )? )
            // com/dyuproject/protostuff/parser/ProtoParser.g:94:9: AT var ( LEFTPAREN annotation_keyval[proto, annotation] ( COMMA annotation_keyval[proto, annotation] )* RIGHTPAREN )?
            {
            root_0 = (Object)adaptor.nil();

            AT17=(Token)match(input,AT,FOLLOW_AT_in_annotation_entry562); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            // com/dyuproject/protostuff/parser/ProtoParser.g:95:9: ( LEFTPAREN annotation_keyval[proto, annotation] ( COMMA annotation_keyval[proto, annotation] )* RIGHTPAREN )?
            int alt6=2;
            switch ( input.LA(1) ) {
                case LEFTPAREN:
                    {
            ...
            switch (alt6) {
                case 1 :
                    // com/dyuproject/protostuff/parser/ProtoParser.g:95:10: LEFTPAREN annotation_keyval[proto, annotation] ( COMMA annotation_keyval[proto, annotation] )* RIGHTPAREN
                    {
                    LEFTPAREN19=(Token)match(input,LEFTPAREN,FOLLOW_LEFTPAREN_in_annotation_entry577); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, annotation_keyval20.getTree());
                    // com/dyuproject/protostuff/parser/ProtoParser.g:96:46: ( COMMA annotation_keyval[proto, annotation] )*
                    loop5:
                    do {
                        int alt5=2;
                        switch ( input.LA(1) ) {
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // com/dyuproject/protostuff/parser/ProtoParser.g:96:47: COMMA annotation_keyval[proto, annotation]
                    	    {
                    	    COMMA21=(Token)match(input,COMMA,FOLLOW_COMMA_in_annotation_entry592); if (state.failed) return retval;
                    	    if ( state.backtracking==0 ) {
                    	    ...
                    	    state._fsp--;
                    	    if (state.failed) return retval;
                    	    if ( state.backtracking==0 ) adaptor.addChild(root_0, annotation_keyval22.getTree());
                    ...
                    RIGHTPAREN23=(Token)match(input,RIGHTPAREN,FOLLOW_RIGHTPAREN_in_annotation_entry608); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:102:1: annotation_keyval[Proto proto, Annotation annotation] : k= var_full ASSIGN (vr= var_reserved | ID | fid= FULL_ID | NUMFLOAT | NUMINT | NUMDOUBLE | TRUE | FALSE | STRING_LITERAL ) ;
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:116:1: header_syntax[Proto proto] : SYNTAX ASSIGN STRING_LITERAL SEMICOLON ;
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:128:1: header_package[Proto proto] : PKG ( FULL_ID | var ) SEMICOLON ;
    public final ProtoParser.header_package_return header_package(Proto proto) throws RecognitionException {
        ...
        try {
            ...
            PKG36=(Token)match(input,PKG,FOLLOW_PKG_in_header_package889); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            switch (alt8) {
                case 1 :
                    ...
                    {
                    FULL_ID37=(Token)match(input,FULL_ID,FOLLOW_FULL_ID_in_header_package892); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
            ...
            SEMICOLON39=(Token)match(input,SEMICOLON,FOLLOW_SEMICOLON_in_header_package903); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:143:1: header_import[Proto proto] : IMPORT STRING_LITERAL SEMICOLON ;
    public final ProtoParser.header_import_return header_import(Proto proto) throws RecognitionException {
        ...
        try {
            ...
            IMPORT40=(Token)match(input,IMPORT,FOLLOW_IMPORT_in_header_import931); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            IMPORT40_tree = (Object)adaptor.create(IMPORT40);
            adaptor.addChild(root_0, IMPORT40_tree);
            }
            STRING_LITERAL41=(Token)match(input,STRING_LITERAL,FOLLOW_STRING_LITERAL_in_header_import933); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            STRING_LITERAL41_tree = (Object)adaptor.create(STRING_LITERAL41);
            adaptor.addChild(root_0, STRING_LITERAL41_tree);
            }
            SEMICOLON42=(Token)match(input,SEMICOLON,FOLLOW_SEMICOLON_in_header_import935); if (state.failed) return retval;
            if ( state.backtracking==0 ) {

                          proto.importProto(getStringFromStringLiteral((STRING_LITERAL41!=null?STRING_LITERAL41.getText():null)));
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:152:1: option_entry[Proto proto, HasOptions ho] : OPTION ( LEFTPAREN )? k= var_full ( RIGHTPAREN )? ASSIGN (vr= var_reserved | id= ID | fid= FULL_ID | NUMFLOAT | NUMINT | NUMDOUBLE | TRUE | FALSE | STRING_LITERAL ) SEMICOLON ;
    public final ProtoParser.option_entry_return option_entry(Proto proto, HasOptions ho) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:153:5: ( OPTION ( LEFTPAREN )? k= var_full ( RIGHTPAREN )? ASSIGN (vr= var_reserved | id= ID | fid= FULL_ID | NUMFLOAT | NUMINT | NUMDOUBLE | TRUE | FALSE | STRING_LITERAL ) SEMICOLON )
            // com/dyuproject/protostuff/parser/ProtoParser.g:153:9: OPTION ( LEFTPAREN )? k= var_full ( RIGHTPAREN )? ASSIGN (vr= var_reserved | id= ID | fid= FULL_ID | NUMFLOAT | NUMINT | NUMDOUBLE | TRUE | FALSE | STRING_LITERAL ) SEMICOLON
            {
            root_0 = (Object)adaptor.nil();

            OPTION43=(Token)match(input,OPTION,FOLLOW_OPTION_in_option_entry959); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            switch (alt9) {
                case 1 :
                    // com/dyuproject/protostuff/parser/ProtoParser.g:153:16: LEFTPAREN
                    {
                    LEFTPAREN44=(Token)match(input,LEFTPAREN,FOLLOW_LEFTPAREN_in_option_entry961); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
            ...
            switch (alt10) {
                case 1 :
                    // com/dyuproject/protostuff/parser/ProtoParser.g:153:38: RIGHTPAREN
                    {
                    RIGHTPAREN45=(Token)match(input,RIGHTPAREN,FOLLOW_RIGHTPAREN_in_option_entry968); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
            ...
            ASSIGN46=(Token)match(input,ASSIGN,FOLLOW_ASSIGN_in_option_entry971); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ASSIGN46_tree = (Object)adaptor.create(ASSIGN46);
            adaptor.addChild(root_0, ASSIGN46_tree);
            }
            // com/dyuproject/protostuff/parser/ProtoParser.g:153:57: (vr= var_reserved | id= ID | fid= FULL_ID | NUMFLOAT | NUMINT | NUMDOUBLE | TRUE | FALSE | STRING_LITERAL )
            int alt11=9;
            switch ( input.LA(1) ) {
            case TO:
            case PKG:
            ...
            switch (alt11) {
                ...
                case 2 :
                    ...
                    {
                    id=(Token)match(input,ID,FOLLOW_ID_in_option_entry1015); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 3 :
                    ...
                    {
                    fid=(Token)match(input,FULL_ID,FOLLOW_FULL_ID_in_option_entry1037); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    fid_tree = (Object)adaptor.create(fid);
                    adaptor.addChild(root_0, fid_tree);
                    }
                ...
                case 4 :
                    ...
                    {
                    NUMFLOAT47=(Token)match(input,NUMFLOAT,FOLLOW_NUMFLOAT_in_option_entry1057); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    NUMFLOAT47_tree = (Object)adaptor.create(NUMFLOAT47);
                    adaptor.addChild(root_0, NUMFLOAT47_tree);
                    }
                    if ( state.backtracking==0 ) {
                       ho.putExtraOption((k!=null?input.toString(k.start,k.stop):null), Float.valueOf((NUMFLOAT47!=null?NUMFLOAT47.getText():null))); 
                    }
                ...
                case 5 :
                    ...
                    {
                    NUMINT48=(Token)match(input,NUMINT,FOLLOW_NUMINT_in_option_entry1077); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    NUMINT48_tree = (Object)adaptor.create(NUMINT48);
                    adaptor.addChild(root_0, NUMINT48_tree);
                    }
                    if ( state.backtracking==0 ) {
                       ho.putExtraOption((k!=null?input.toString(k.start,k.stop):null), Integer.valueOf((NUMINT48!=null?NUMINT48.getText():null))); 
                    }
                ...
                case 6 :
                    ...
                    {
                    NUMDOUBLE49=(Token)match(input,NUMDOUBLE,FOLLOW_NUMDOUBLE_in_option_entry1097); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    NUMDOUBLE49_tree = (Object)adaptor.create(NUMDOUBLE49);
                    adaptor.addChild(root_0, NUMDOUBLE49_tree);
                    }
                    if ( state.backtracking==0 ) {
                       ho.putExtraOption((k!=null?input.toString(k.start,k.stop):null), Double.valueOf((NUMDOUBLE49!=null?NUMDOUBLE49.getText():null))); 
                    }
                ...
                case 7 :
                    ...
                    {
                    TRUE50=(Token)match(input,TRUE,FOLLOW_TRUE_in_option_entry1117); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 8 :
                    ...
                    {
                    FALSE51=(Token)match(input,FALSE,FOLLOW_FALSE_in_option_entry1137); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 9 :
                    ...
                    {
                    STRING_LITERAL52=(Token)match(input,STRING_LITERAL,FOLLOW_STRING_LITERAL_in_option_entry1157); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    STRING_LITERAL52_tree = (Object)adaptor.create(STRING_LITERAL52);
                    adaptor.addChild(root_0, STRING_LITERAL52_tree);
                    }
                    if ( state.backtracking==0 ) {
                       ho.putExtraOption((k!=null?input.toString(k.start,k.stop):null), getStringFromStringLiteral((STRING_LITERAL52!=null?STRING_LITERAL52.getText():null))); 
                    }
            ...
            SEMICOLON53=(Token)match(input,SEMICOLON,FOLLOW_SEMICOLON_in_option_entry1171); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:169:1: message_block[Proto proto, Message parent] : MESSAGE ID LEFTCURLY ( message_body[proto, message] )* RIGHTCURLY ;
    public final ProtoParser.message_block_return message_block(Proto proto, Message parent) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:173:5: ( MESSAGE ID LEFTCURLY ( message_body[proto, message] )* RIGHTCURLY )
            // com/dyuproject/protostuff/parser/ProtoParser.g:173:9: MESSAGE ID LEFTCURLY ( message_body[proto, message] )* RIGHTCURLY
            {
            root_0 = (Object)adaptor.nil();

            MESSAGE54=(Token)match(input,MESSAGE,FOLLOW_MESSAGE_in_message_block1204); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            MESSAGE54_tree = (Object)adaptor.create(MESSAGE54);
            adaptor.addChild(root_0, MESSAGE54_tree);
            }
            ID55=(Token)match(input,ID,FOLLOW_ID_in_message_block1206); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            LEFTCURLY56=(Token)match(input,LEFTCURLY,FOLLOW_LEFTCURLY_in_message_block1219); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    if (state.failed) return retval;
            	    if ( state.backtracking==0 ) adaptor.addChild(root_0, message_body57.getTree());
            ...
            RIGHTCURLY58=(Token)match(input,RIGHTCURLY,FOLLOW_RIGHTCURLY_in_message_block1227); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:183:1: message_body[Proto proto, Message message] : ( message_block[proto, message] | message_field[proto, message] | enum_block[proto, message] | service_block[proto, message] | extend_block[proto, message] | extensions_range[proto, message] | annotation_entry[proto] | option_entry[proto, message] );
    public final ProtoParser.message_body_return message_body(Proto proto, Message message) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:184:5: ( message_block[proto, message] | message_field[proto, message] | enum_block[proto, message] | service_block[proto, message] | extend_block[proto, message] | extensions_range[proto, message] | annotation_entry[proto] | option_entry[proto, message] )
            int alt13=8;
            switch ( input.LA(1) ) {
            case MESSAGE:
                {
            ...
            switch (alt13) {
                case 1 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, message_block59.getTree());
                ...
                case 2 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, message_field60.getTree());
                ...
                case 3 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, enum_block61.getTree());
                ...
                case 4 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, service_block62.getTree());
                ...
                case 5 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, extend_block63.getTree());
                ...
                case 6 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, extensions_range64.getTree());
                ...
                case 7 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, annotation_entry65.getTree());
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:194:1: extensions_range[Proto proto, Message message] : EXTENSIONS f= NUMINT ( TO (l= NUMINT | MAX ) )? SEMICOLON ;
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:206:1: message_field[Proto proto, HasFields message] : ( OPTIONAL | REQUIRED | REPEATED ) field_type[proto, message, fieldHolder] var ASSIGN NUMINT ( field_options[proto, message, fieldHolder.field] )? ( SEMICOLON | ignore_block ) ;
    public final ProtoParser.message_field_return message_field(Proto proto, HasFields message) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:211:5: ( ( OPTIONAL | REQUIRED | REPEATED ) field_type[proto, message, fieldHolder] var ASSIGN NUMINT ( field_options[proto, message, fieldHolder.field] )? ( SEMICOLON | ignore_block ) )
            // com/dyuproject/protostuff/parser/ProtoParser.g:211:9: ( OPTIONAL | REQUIRED | REPEATED ) field_type[proto, message, fieldHolder] var ASSIGN NUMINT ( field_options[proto, message, fieldHolder.field] )? ( SEMICOLON | ignore_block )
            {
            root_0 = (Object)adaptor.nil();
            ...
            switch (alt16) {
                case 1 :
                    ...
                    {
                    OPTIONAL71=(Token)match(input,OPTIONAL,FOLLOW_OPTIONAL_in_message_field1439); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 2 :
                    ...
                    {
                    REQUIRED72=(Token)match(input,REQUIRED,FOLLOW_REQUIRED_in_message_field1456); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 3 :
                    ...
                    {
                    REPEATED73=(Token)match(input,REPEATED,FOLLOW_REPEATED_in_message_field1473); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
            ...
            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) adaptor.addChild(root_0, field_type74.getTree());
            ...
            ASSIGN76=(Token)match(input,ASSIGN,FOLLOW_ASSIGN_in_message_field1502); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ASSIGN76_tree = (Object)adaptor.create(ASSIGN76);
            adaptor.addChild(root_0, ASSIGN76_tree);
            }
            NUMINT77=(Token)match(input,NUMINT,FOLLOW_NUMINT_in_message_field1504); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            // com/dyuproject/protostuff/parser/ProtoParser.g:224:9: ( field_options[proto, message, fieldHolder.field] )?
            int alt17=2;
            switch ( input.LA(1) ) {
                case LEFTSQUARE:
                    {
            ...
            switch (alt17) {
                case 1 :
                    // com/dyuproject/protostuff/parser/ProtoParser.g:224:10: field_options[proto, message, fieldHolder.field]
                    {
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, field_options78.getTree());
            ...
            switch (alt18) {
                case 1 :
                    ...
                    {
                    SEMICOLON79=(Token)match(input,SEMICOLON,FOLLOW_SEMICOLON_in_message_field1534); if (state.failed) return retval;
                ...
                case 2 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, ignore_block80.getTree());
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:233:1: field_type[Proto proto, HasFields message, FieldHolder fieldHolder] : ( INT32 | UINT32 | SINT32 | FIXED32 | SFIXED32 | INT64 | UINT64 | SINT64 | FIXED64 | SFIXED64 | FLOAT | DOUBLE | BOOL | STRING | BYTES | GROUP | FULL_ID | ID );
    public final ProtoParser.field_type_return field_type(Proto proto, HasFields message, FieldHolder fieldHolder) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:234:5: ( INT32 | UINT32 | SINT32 | FIXED32 | SFIXED32 | INT64 | UINT64 | SINT64 | FIXED64 | SFIXED64 | FLOAT | DOUBLE | BOOL | STRING | BYTES | GROUP | FULL_ID | ID )
            int alt19=18;
            switch ( input.LA(1) ) {
            case INT32:
                {
            ...
            switch (alt19) {
                case 1 :
                    ...
                    INT3281=(Token)match(input,INT32,FOLLOW_INT32_in_field_type1565); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 2 :
                    ...
                    UINT3282=(Token)match(input,UINT32,FOLLOW_UINT32_in_field_type1577); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 3 :
                    ...
                    SINT3283=(Token)match(input,SINT32,FOLLOW_SINT32_in_field_type1589); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 4 :
                    ...
                    FIXED3284=(Token)match(input,FIXED32,FOLLOW_FIXED32_in_field_type1601); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 5 :
                    ...
                    SFIXED3285=(Token)match(input,SFIXED32,FOLLOW_SFIXED32_in_field_type1613); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 6 :
                    ...
                    INT6486=(Token)match(input,INT64,FOLLOW_INT64_in_field_type1625); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 7 :
                    ...
                    UINT6487=(Token)match(input,UINT64,FOLLOW_UINT64_in_field_type1637); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 8 :
                    ...
                    SINT6488=(Token)match(input,SINT64,FOLLOW_SINT64_in_field_type1649); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 9 :
                    ...
                    FIXED6489=(Token)match(input,FIXED64,FOLLOW_FIXED64_in_field_type1661); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 10 :
                    ...
                    SFIXED6490=(Token)match(input,SFIXED64,FOLLOW_SFIXED64_in_field_type1673); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 11 :
                    ...
                    FLOAT91=(Token)match(input,FLOAT,FOLLOW_FLOAT_in_field_type1685); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 12 :
                    ...
                    DOUBLE92=(Token)match(input,DOUBLE,FOLLOW_DOUBLE_in_field_type1697); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 13 :
                    ...
                    BOOL93=(Token)match(input,BOOL,FOLLOW_BOOL_in_field_type1709); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 14 :
                    ...
                    STRING94=(Token)match(input,STRING,FOLLOW_STRING_in_field_type1721); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 15 :
                    ...
                    BYTES95=(Token)match(input,BYTES,FOLLOW_BYTES_in_field_type1733); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 16 :
                    ...
                    GROUP96=(Token)match(input,GROUP,FOLLOW_GROUP_in_field_type1745); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 17 :
                    ...
                    FULL_ID97=(Token)match(input,FULL_ID,FOLLOW_FULL_ID_in_field_type1757); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 18 :
                    ...
                    ID98=(Token)match(input,ID,FOLLOW_ID_in_field_type1769); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:266:1: field_options[Proto proto, HasFields message, Field field] : LEFTSQUARE field_options_keyval[proto, message, field, true] ( COMMA field_options_keyval[proto, message, field, true] )* RIGHTSQUARE ;
    public final ProtoParser.field_options_return field_options(Proto proto, HasFields message, Field field) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:267:5: ( LEFTSQUARE field_options_keyval[proto, message, field, true] ( COMMA field_options_keyval[proto, message, field, true] )* RIGHTSQUARE )
            // com/dyuproject/protostuff/parser/ProtoParser.g:267:9: LEFTSQUARE field_options_keyval[proto, message, field, true] ( COMMA field_options_keyval[proto, message, field, true] )* RIGHTSQUARE
            {
            root_0 = (Object)adaptor.nil();

            LEFTSQUARE99=(Token)match(input,LEFTSQUARE,FOLLOW_LEFTSQUARE_in_field_options1796); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) adaptor.addChild(root_0, field_options_keyval100.getTree());
            // com/dyuproject/protostuff/parser/ProtoParser.g:268:9: ( COMMA field_options_keyval[proto, message, field, true] )*
            loop20:
            do {
                int alt20=2;
                switch ( input.LA(1) ) {
                ...
                switch (alt20) {
            	case 1 :
            	    // com/dyuproject/protostuff/parser/ProtoParser.g:268:10: COMMA field_options_keyval[proto, message, field, true]
            	    {
            	    COMMA101=(Token)match(input,COMMA,FOLLOW_COMMA_in_field_options1811); if (state.failed) return retval;
            	    if ( state.backtracking==0 ) {
            	    ...
            	    state._fsp--;
            	    if (state.failed) return retval;
            	    if ( state.backtracking==0 ) adaptor.addChild(root_0, field_options_keyval102.getTree());
            ...
            RIGHTSQUARE103=(Token)match(input,RIGHTSQUARE,FOLLOW_RIGHTSQUARE_in_field_options1818); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:271:1: field_options_keyval[Proto proto, HasFields message, Field field, boolean checkDefault] : key= var_full ASSIGN (vr= var_reserved | STRING_LITERAL | NUMFLOAT | NUMINT | NUMDOUBLE | HEX | OCTAL | TRUE | FALSE | val= ID | FULL_ID | EXP | signed_constant[proto, message, field, $key.text, checkDefault] ) ;
    public final ProtoParser.field_options_keyval_return field_options_keyval(Proto proto, HasFields message, Field field, boolean checkDefault) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:272:5: (key= var_full ASSIGN (vr= var_reserved | STRING_LITERAL | NUMFLOAT | NUMINT | NUMDOUBLE | HEX | OCTAL | TRUE | FALSE | val= ID | FULL_ID | EXP | signed_constant[proto, message, field, $key.text, checkDefault] ) )
            // com/dyuproject/protostuff/parser/ProtoParser.g:272:9: key= var_full ASSIGN (vr= var_reserved | STRING_LITERAL | NUMFLOAT | NUMINT | NUMDOUBLE | HEX | OCTAL | TRUE | FALSE | val= ID | FULL_ID | EXP | signed_constant[proto, message, field, $key.text, checkDefault] )
            {
            root_0 = (Object)adaptor.nil();
            ...
            ASSIGN104=(Token)match(input,ASSIGN,FOLLOW_ASSIGN_in_field_options_keyval1847); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ASSIGN104_tree = (Object)adaptor.create(ASSIGN104);
            adaptor.addChild(root_0, ASSIGN104_tree);
            }
            // com/dyuproject/protostuff/parser/ProtoParser.g:272:29: (vr= var_reserved | STRING_LITERAL | NUMFLOAT | NUMINT | NUMDOUBLE | HEX | OCTAL | TRUE | FALSE | val= ID | FULL_ID | EXP | signed_constant[proto, message, field, $key.text, checkDefault] )
            int alt21=13;
            switch ( input.LA(1) ) {
            case TO:
            case PKG:
            ...
            switch (alt21) {
                ...
                case 2 :
                    ...
                    {
                    STRING_LITERAL105=(Token)match(input,STRING_LITERAL,FOLLOW_STRING_LITERAL_in_field_options_keyval1865); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    if ( state.backtracking==0 ) {
                                  ...
                                  if(checkDefault && "default".equals((key!=null?input.toString(key.start,key.stop):null))) {
                                      ...
                                      if(field instanceof Field.String)
                                          field.defaultValue = getStringFromStringLiteral((STRING_LITERAL105!=null?STRING_LITERAL105.getText():null));
                                      else if(field instanceof Field.Bytes)
                                          field.defaultValue = getBytesFromStringLiteral((STRING_LITERAL105!=null?STRING_LITERAL105.getText():null));
                                      else
                                          throw new IllegalStateException("Invalid string default value for the field: " + field.getClass().getSimpleName() + " " + field.name);
                                  }
                                  
                                  field.putExtraOption((key!=null?input.toString(key.start,key.stop):null), getStringFromStringLiteral((STRING_LITERAL105!=null?STRING_LITERAL105.getText():null)));
                ...
                case 3 :
                    ...
                    {
                    NUMFLOAT106=(Token)match(input,NUMFLOAT,FOLLOW_NUMFLOAT_in_field_options_keyval1877); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    if ( state.backtracking==0 ) {
                                  ...
                                  if(checkDefault && "default".equals((key!=null?input.toString(key.start,key.stop):null))) {
                                      ...
                                      if(field instanceof Field.Float)
                                          field.defaultValue = Float.valueOf((NUMFLOAT106!=null?NUMFLOAT106.getText():null));
                                      else if(field instanceof Field.Double) 
                                          field.defaultValue = Double.valueOf((NUMFLOAT106!=null?NUMFLOAT106.getText():null));
                                      else
                                          throw new IllegalStateException("Invalid float default value for the field: " + field.getClass().getSimpleName() + " " + field.name);
                                  }
                                  
                                  field.putExtraOption((key!=null?input.toString(key.start,key.stop):null), Float.valueOf((NUMFLOAT106!=null?NUMFLOAT106.getText():null)));
                ...
                case 4 :
                    ...
                    {
                    NUMINT107=(Token)match(input,NUMINT,FOLLOW_NUMINT_in_field_options_keyval1890); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    if ( state.backtracking==0 ) {
                                  ...
                                  if(checkDefault && "default".equals((key!=null?input.toString(key.start,key.stop):null))) {
                                      ...
                                      if(field instanceof Field.Number) {
                                          if(field.getClass().getSimpleName().endsWith("32"))
                                              field.defaultValue = Integer.valueOf((NUMINT107!=null?NUMINT107.getText():null));
                                          else if(field.getClass().getSimpleName().endsWith("64"))
                                              field.defaultValue = Long.valueOf((NUMINT107!=null?NUMINT107.getText():null));
                                          else if(field instanceof Field.Float)
                                              field.defaultValue = Float.valueOf((NUMINT107!=null?NUMINT107.getText():null));
                                          else if(field instanceof Field.Double) 
                                              field.defaultValue = Double.valueOf((NUMINT107!=null?NUMINT107.getText():null));
                                          else
                                  ...
                                  field.putExtraOption((key!=null?input.toString(key.start,key.stop):null), Integer.valueOf((NUMINT107!=null?NUMINT107.getText():null)));
                ...
                case 5 :
                    ...
                    {
                    NUMDOUBLE108=(Token)match(input,NUMDOUBLE,FOLLOW_NUMDOUBLE_in_field_options_keyval1902); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    if ( state.backtracking==0 ) {
                                  ...
                                  if(checkDefault && "default".equals((key!=null?input.toString(key.start,key.stop):null))) {
                                      ...
                                      if(field instanceof Field.Float)
                                          field.defaultValue = Float.valueOf((NUMDOUBLE108!=null?NUMDOUBLE108.getText():null));
                                      else if(field instanceof Field.Double) 
                                          field.defaultValue = Double.valueOf((NUMDOUBLE108!=null?NUMDOUBLE108.getText():null));
                                      else
                                          throw new IllegalStateException("Invalid numeric default value for the field: " + field.getClass().getSimpleName() + " " + field.name);
                                  }
                                  
                                  field.putExtraOption((key!=null?input.toString(key.start,key.stop):null), Double.valueOf((NUMDOUBLE108!=null?NUMDOUBLE108.getText():null)));
                ...
                case 6 :
                    ...
                    {
                    HEX109=(Token)match(input,HEX,FOLLOW_HEX_in_field_options_keyval1914); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    if ( state.backtracking==0 ) {
                                  ...
                                  if(checkDefault && "default".equals((key!=null?input.toString(key.start,key.stop):null))) {
                                      ...
                                      if(field instanceof Field.Number) {
                                          if(field instanceof Field.Int32)
                                              field.defaultValue = new Integer(TextFormat.parseInt32((HEX109!=null?HEX109.getText():null)));
                                          else if(field instanceof Field.UInt32)
                                              field.defaultValue = new Integer(TextFormat.parseUInt32((HEX109!=null?HEX109.getText():null)));
                                          else if(field instanceof Field.Int64)
                                              field.defaultValue = new Long(TextFormat.parseInt64((HEX109!=null?HEX109.getText():null)));
                                          else if(field instanceof Field.UInt64)
                                              field.defaultValue = new Long(TextFormat.parseUInt64((HEX109!=null?HEX109.getText():null)));
                                          else if(field instanceof Field.Float)
                                              field.defaultValue = new Float(Long.decode((HEX109!=null?HEX109.getText():null)).floatValue());
                                          else if(field instanceof Field.Double) 
                                              field.defaultValue = new Double(Long.decode((HEX109!=null?HEX109.getText():null)).doubleValue());
                                      }
                                      else if(field instanceof Field.Bytes) {
                                          field.defaultValue = getBytesFromHexString((HEX109!=null?HEX109.getText():null));
                                      }
                                      else
                                          throw new IllegalStateException("Invalid numeric default value for the field: " + field.getClass().getSimpleName() + " " + field.name);
                                  ...
                                  field.putExtraOption((key!=null?input.toString(key.start,key.stop):null), (HEX109!=null?HEX109.getText():null));
                ...
                case 7 :
                    ...
                    {
                    OCTAL110=(Token)match(input,OCTAL,FOLLOW_OCTAL_in_field_options_keyval1926); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    if ( state.backtracking==0 ) {
                                  ...
                                  if(checkDefault && "default".equals((key!=null?input.toString(key.start,key.stop):null))) {
                                      ...
                                      if(field instanceof Field.Number) {
                                          if(field instanceof Field.Int32)
                                              field.defaultValue = new Integer(TextFormat.parseInt32((OCTAL110!=null?OCTAL110.getText():null)));
                                          else if(field instanceof Field.UInt32)
                                              field.defaultValue = new Integer(TextFormat.parseUInt32((OCTAL110!=null?OCTAL110.getText():null)));
                                          else if(field instanceof Field.Int64)
                                              field.defaultValue = new Long(TextFormat.parseInt64((OCTAL110!=null?OCTAL110.getText():null)));
                                          else if(field instanceof Field.UInt64)
                                              field.defaultValue = new Long(TextFormat.parseUInt64((OCTAL110!=null?OCTAL110.getText():null)));
                                          else if(field instanceof Field.Float)
                                              field.defaultValue = new Float(Long.decode((OCTAL110!=null?OCTAL110.getText():null)).floatValue());
                                          else if(field instanceof Field.Double) 
                                              field.defaultValue = new Double(Long.decode((OCTAL110!=null?OCTAL110.getText():null)).doubleValue());
                                      }
                                      else
                                          throw new IllegalStateException("Invalid numeric default value for the field: " + field.getClass().getSimpleName() + " " + field.name);
                                  }
                                  
                                  field.putExtraOption((key!=null?input.toString(key.start,key.stop):null), (OCTAL110!=null?OCTAL110.getText():null));
                ...
                case 8 :
                    ...
                    {
                    TRUE111=(Token)match(input,TRUE,FOLLOW_TRUE_in_field_options_keyval1938); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 9 :
                    ...
                    {
                    FALSE112=(Token)match(input,FALSE,FOLLOW_FALSE_in_field_options_keyval1954); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 10 :
                    ...
                    {
                    val=(Token)match(input,ID,FOLLOW_ID_in_field_options_keyval1968); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 11 :
                    ...
                    {
                    FULL_ID113=(Token)match(input,FULL_ID,FOLLOW_FULL_ID_in_field_options_keyval1980); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    if ( state.backtracking==0 ) {
                                  ...
                                  field.putStandardOption((key!=null?input.toString(key.start,key.stop):null), (FULL_ID113!=null?FULL_ID113.getText():null));
                ...
                case 12 :
                    ...
                    {
                    EXP114=(Token)match(input,EXP,FOLLOW_EXP_in_field_options_keyval1992); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    if ( state.backtracking==0 ) {
                                  ...
                                  field.putExtraOption((key!=null?input.toString(key.start,key.stop):null), (EXP114!=null?EXP114.getText():null));
                    ...
                    break;
                case 13 :
                    // com/dyuproject/protostuff/parser/ProtoParser.g:488:9: signed_constant[proto, message, field, $key.text, checkDefault]
                    {
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, signed_constant115.getTree());
                    if ( state.backtracking==0 ) {
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:494:1: signed_constant[Proto proto, HasFields message, Field field, String key, boolean checkDefault] : MINUS ID ;
    public final ProtoParser.signed_constant_return signed_constant(Proto proto, HasFields message, Field field, String key, boolean checkDefault) throws RecognitionException {
        ...
        try {
            ...
            MINUS116=(Token)match(input,MINUS,FOLLOW_MINUS_in_signed_constant2042); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            MINUS116_tree = (Object)adaptor.create(MINUS116);
            adaptor.addChild(root_0, MINUS116_tree);
            }
            ID117=(Token)match(input,ID,FOLLOW_ID_in_signed_constant2044); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:523:1: enum_block[Proto proto, Message message] : ENUM ID LEFTCURLY ( enum_body[proto, message, enumGroup] )* RIGHTCURLY ( ( SEMICOLON )? ) ;
    public final ProtoParser.enum_block_return enum_block(Proto proto, Message message) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:527:5: ( ENUM ID LEFTCURLY ( enum_body[proto, message, enumGroup] )* RIGHTCURLY ( ( SEMICOLON )? ) )
            // com/dyuproject/protostuff/parser/ProtoParser.g:527:9: ENUM ID LEFTCURLY ( enum_body[proto, message, enumGroup] )* RIGHTCURLY ( ( SEMICOLON )? )
            {
            root_0 = (Object)adaptor.nil();

            ENUM118=(Token)match(input,ENUM,FOLLOW_ENUM_in_enum_block2076); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ENUM118_tree = (Object)adaptor.create(ENUM118);
            adaptor.addChild(root_0, ENUM118_tree);
            }
            ID119=(Token)match(input,ID,FOLLOW_ID_in_enum_block2078); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            LEFTCURLY120=(Token)match(input,LEFTCURLY,FOLLOW_LEFTCURLY_in_enum_block2091); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    if (state.failed) return retval;
            	    if ( state.backtracking==0 ) adaptor.addChild(root_0, enum_body121.getTree());
            ...
            RIGHTCURLY122=(Token)match(input,RIGHTCURLY,FOLLOW_RIGHTCURLY_in_enum_block2099); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            switch (alt23) {
                case 1 :
                    // com/dyuproject/protostuff/parser/ProtoParser.g:534:12: SEMICOLON
                    {
                    SEMICOLON123=(Token)match(input,SEMICOLON,FOLLOW_SEMICOLON_in_enum_block2104); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:543:1: enum_field[Proto proto, Message message, EnumGroup enumGroup] : ID ASSIGN NUMINT ( enum_options[proto, enumGroup, v] )? SEMICOLON ;
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:553:1: enum_options[Proto proto, EnumGroup enumGroup, EnumGroup.Value v] : LEFTSQUARE field_options_keyval[proto, null, v.field, false] ( COMMA field_options_keyval[proto, null, v.field, false] )* RIGHTSQUARE ;
    public final ProtoParser.enum_options_return enum_options(Proto proto, EnumGroup enumGroup, EnumGroup.Value v) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:554:5: ( LEFTSQUARE field_options_keyval[proto, null, v.field, false] ( COMMA field_options_keyval[proto, null, v.field, false] )* RIGHTSQUARE )
            // com/dyuproject/protostuff/parser/ProtoParser.g:554:9: LEFTSQUARE field_options_keyval[proto, null, v.field, false] ( COMMA field_options_keyval[proto, null, v.field, false] )* RIGHTSQUARE
            {
            root_0 = (Object)adaptor.nil();

            LEFTSQUARE132=(Token)match(input,LEFTSQUARE,FOLLOW_LEFTSQUARE_in_enum_options2218); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) adaptor.addChild(root_0, field_options_keyval133.getTree());
            // com/dyuproject/protostuff/parser/ProtoParser.g:555:9: ( COMMA field_options_keyval[proto, null, v.field, false] )*
            loop26:
            do {
                int alt26=2;
                switch ( input.LA(1) ) {
                ...
                switch (alt26) {
            	case 1 :
            	    // com/dyuproject/protostuff/parser/ProtoParser.g:555:10: COMMA field_options_keyval[proto, null, v.field, false]
            	    {
            	    COMMA134=(Token)match(input,COMMA,FOLLOW_COMMA_in_enum_options2233); if (state.failed) return retval;
            	    if ( state.backtracking==0 ) {
            	    ...
            	    state._fsp--;
            	    if (state.failed) return retval;
            	    if ( state.backtracking==0 ) adaptor.addChild(root_0, field_options_keyval135.getTree());
            ...
            RIGHTSQUARE136=(Token)match(input,RIGHTSQUARE,FOLLOW_RIGHTSQUARE_in_enum_options2240); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:558:1: service_block[Proto proto, Message message] : SERVICE ID LEFTCURLY ( service_body[proto, service] )+ RIGHTCURLY ( ( SEMICOLON )? ) ;
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:575:1: service_body[Proto proto, Service service] : ( rpc_block[proto, service] | annotation_entry[proto] | option_entry[proto, service] );
    public final ProtoParser.service_body_return service_body(Proto proto, Service service) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:576:5: ( rpc_block[proto, service] | annotation_entry[proto] | option_entry[proto, service] )
            int alt29=3;
            switch ( input.LA(1) ) {
            case RPC:
                {
            ...
            switch (alt29) {
                case 1 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, rpc_block143.getTree());
                ...
                case 2 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, annotation_entry144.getTree());
                ...
                case 3 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, option_entry145.getTree());
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:581:1: rpc_block[Proto proto, Service service] : RPC n= ID LEFTPAREN (ap= FULL_ID | a= ( VOID | ID ) ) RIGHTPAREN RETURNS LEFTPAREN (rp= FULL_ID | r= ( VOID | ID ) ) RIGHTPAREN ( rpc_body_block[proto, rm] )? SEMICOLON ;
    public final ProtoParser.rpc_block_return rpc_block(Proto proto, Service service) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:586:5: ( RPC n= ID LEFTPAREN (ap= FULL_ID | a= ( VOID | ID ) ) RIGHTPAREN RETURNS LEFTPAREN (rp= FULL_ID | r= ( VOID | ID ) ) RIGHTPAREN ( rpc_body_block[proto, rm] )? SEMICOLON )
            // com/dyuproject/protostuff/parser/ProtoParser.g:586:9: RPC n= ID LEFTPAREN (ap= FULL_ID | a= ( VOID | ID ) ) RIGHTPAREN RETURNS LEFTPAREN (rp= FULL_ID | r= ( VOID | ID ) ) RIGHTPAREN ( rpc_body_block[proto, rm] )? SEMICOLON
            {
            root_0 = (Object)adaptor.nil();

            RPC146=(Token)match(input,RPC,FOLLOW_RPC_in_rpc_block2378); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            RPC146_tree = (Object)adaptor.create(RPC146);
            adaptor.addChild(root_0, RPC146_tree);
            }
            n=(Token)match(input,ID,FOLLOW_ID_in_rpc_block2382); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            n_tree = (Object)adaptor.create(n);
            adaptor.addChild(root_0, n_tree);
            }
            LEFTPAREN147=(Token)match(input,LEFTPAREN,FOLLOW_LEFTPAREN_in_rpc_block2384); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            switch (alt30) {
                case 1 :
                    ...
                    {
                    ap=(Token)match(input,FULL_ID,FOLLOW_FULL_ID_in_rpc_block2389); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
            ...
            RIGHTPAREN148=(Token)match(input,RIGHTPAREN,FOLLOW_RIGHTPAREN_in_rpc_block2406); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            RIGHTPAREN148_tree = (Object)adaptor.create(RIGHTPAREN148);
            adaptor.addChild(root_0, RIGHTPAREN148_tree);
            }
            RETURNS149=(Token)match(input,RETURNS,FOLLOW_RETURNS_in_rpc_block2417); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            RETURNS149_tree = (Object)adaptor.create(RETURNS149);
            adaptor.addChild(root_0, RETURNS149_tree);
            }
            LEFTPAREN150=(Token)match(input,LEFTPAREN,FOLLOW_LEFTPAREN_in_rpc_block2419); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            switch (alt31) {
                case 1 :
                    ...
                    {
                    rp=(Token)match(input,FULL_ID,FOLLOW_FULL_ID_in_rpc_block2424); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
            ...
            RIGHTPAREN151=(Token)match(input,RIGHTPAREN,FOLLOW_RIGHTPAREN_in_rpc_block2441); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            switch (alt32) {
                case 1 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, rpc_body_block152.getTree());
            ...
            SEMICOLON153=(Token)match(input,SEMICOLON,FOLLOW_SEMICOLON_in_rpc_block2449); if (state.failed) return retval;
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:603:1: rpc_body_block[Proto proto, Service.RpcMethod rm] : LEFTCURLY ( option_entry[proto, rm] )* RIGHTCURLY ;
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:610:1: extend_block[Proto proto, Message parent] : EXTEND ( FULL_ID | ID ) LEFTCURLY ( extend_body[proto, extension] )* RIGHTCURLY ( ( SEMICOLON )? ) ;
    public final ProtoParser.extend_block_return extend_block(Proto proto, Message parent) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:614:5: ( EXTEND ( FULL_ID | ID ) LEFTCURLY ( extend_body[proto, extension] )* RIGHTCURLY ( ( SEMICOLON )? ) )
            // com/dyuproject/protostuff/parser/ProtoParser.g:614:9: EXTEND ( FULL_ID | ID ) LEFTCURLY ( extend_body[proto, extension] )* RIGHTCURLY ( ( SEMICOLON )? )
            {
            root_0 = (Object)adaptor.nil();

            EXTEND157=(Token)match(input,EXTEND,FOLLOW_EXTEND_in_extend_block2513); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            switch (alt34) {
                case 1 :
                    ...
                    {
                    FULL_ID158=(Token)match(input,FULL_ID,FOLLOW_FULL_ID_in_extend_block2525); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                ...
                case 2 :
                    ...
                    {
                    ID159=(Token)match(input,ID,FOLLOW_ID_in_extend_block2531); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
            ...
            LEFTCURLY160=(Token)match(input,LEFTCURLY,FOLLOW_LEFTCURLY_in_extend_block2547); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    if (state.failed) return retval;
            	    if ( state.backtracking==0 ) adaptor.addChild(root_0, extend_body161.getTree());
            ...
            RIGHTCURLY162=(Token)match(input,RIGHTCURLY,FOLLOW_RIGHTCURLY_in_extend_block2555); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            switch (alt36) {
                case 1 :
                    // com/dyuproject/protostuff/parser/ProtoParser.g:633:12: SEMICOLON
                    {
                    SEMICOLON163=(Token)match(input,SEMICOLON,FOLLOW_SEMICOLON_in_extend_block2560); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:636:1: extend_body[Proto proto, Extension extension] : ( message_field[proto, extension] | annotation_entry[proto] );
    public final ProtoParser.extend_body_return extend_body(Proto proto, Extension extension) throws RecognitionException {
        ...
        try {
            // com/dyuproject/protostuff/parser/ProtoParser.g:637:5: ( message_field[proto, extension] | annotation_entry[proto] )
            int alt37=2;
            switch ( input.LA(1) ) {
            case REQUIRED:
            case OPTIONAL:
            ...
            switch (alt37) {
                case 1 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, message_field164.getTree());
                ...
                case 2 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, annotation_entry165.getTree());
    ...
    // com/dyuproject/protostuff/parser/ProtoParser.g:645:1: ignore_block_body : ( ( LEFTCURLY )=> ignore_block | ~ RIGHTCURLY );
        ...
        try {
            ...
            switch (alt39) {
                case 1 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, ignore_block169.getTree());
    ...
    public final void synpred1_ProtoParser_fragment() throws RecognitionException {   
        ...
        {
        match(input,LEFTCURLY,FOLLOW_LEFTCURLY_in_synpred1_ProtoParser2652); if (state.failed) return ;
    ...
    public static final BitSet FOLLOW_annotation_keyval_in_annotation_entry588 = new BitSet(new long[]{0x0000000000002200L});
    public static final BitSet FOLLOW_COMMA_in_annotation_entry592 = new BitSet(new long[]{0x003FFFFFFFF90000L});
    public static final BitSet FOLLOW_annotation_keyval_in_annotation_entry594 = new BitSet(new long[]{0x0000000000002200L});
    ...
    public static final BitSet FOLLOW_ASSIGN_in_annotation_keyval637 = new BitSet(new long[]{0x037FFFFFFFFF0000L,0x0000000000000001L});
    public static final BitSet FOLLOW_var_reserved_in_annotation_keyval659 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_STRING_LITERAL_in_annotation_keyval821 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SYNTAX_in_header_syntax854 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_ASSIGN_in_header_syntax856 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_STRING_LITERAL_in_header_syntax858 = new BitSet(new long[]{0x0000000000001000L});
    ...
    public static final BitSet FOLLOW_IMPORT_in_header_import931 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_STRING_LITERAL_in_header_import933 = new BitSet(new long[]{0x0000000000001000L});
    ...
    public static final BitSet FOLLOW_ASSIGN_in_option_entry971 = new BitSet(new long[]{0x037FFFFFFFFF0000L,0x0000000000000001L});
    ...
    public static final BitSet FOLLOW_STRING_LITERAL_in_option_entry1157 = new BitSet(new long[]{0x0000000000001000L});
    ...
    public static final BitSet FOLLOW_extensions_range_in_message_body1305 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_annotation_entry_in_message_body1316 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_option_entry_in_message_body1327 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EXTENSIONS_in_extensions_range1358 = new BitSet(new long[]{0x0040000000000000L});
    ...
    public static final BitSet FOLLOW_field_options_in_message_field1518 = new BitSet(new long[]{0x0000000000001440L});
    ...
    public static final BitSet FOLLOW_field_options_keyval_in_field_options1798 = new BitSet(new long[]{0x0000000000002800L});
    public static final BitSet FOLLOW_COMMA_in_field_options1811 = new BitSet(new long[]{0x003FFFFFFFF90000L});
    public static final BitSet FOLLOW_field_options_keyval_in_field_options1813 = new BitSet(new long[]{0x0000000000002800L});
    public static final BitSet FOLLOW_RIGHTSQUARE_in_field_options1818 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_var_full_in_field_options_keyval1845 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_ASSIGN_in_field_options_keyval1847 = new BitSet(new long[]{0x1BFFFFFFFFFF8000L,0x0000000000000001L});
    public static final BitSet FOLLOW_var_reserved_in_field_options_keyval1852 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_LITERAL_in_field_options_keyval1865 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NUMFLOAT_in_field_options_keyval1877 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NUMINT_in_field_options_keyval1890 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NUMDOUBLE_in_field_options_keyval1902 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_FULL_ID_in_field_options_keyval1980 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EXP_in_field_options_keyval1992 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_signed_constant_in_field_options_keyval2004 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_field_options_keyval_in_enum_options2220 = new BitSet(new long[]{0x0000000000002800L});
    public static final BitSet FOLLOW_COMMA_in_enum_options2233 = new BitSet(new long[]{0x003FFFFFFFF90000L});
    public static final BitSet FOLLOW_field_options_keyval_in_enum_options2235 = new BitSet(new long[]{0x0000000000002800L});
    ...
    public static final BitSet FOLLOW_annotation_entry_in_service_body2336 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_option_entry_in_rpc_body_block2477 = new BitSet(new long[]{0x0000000043F800A0L});
    ...
    public static final BitSet FOLLOW_annotation_entry_in_extend_body2599 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LEFTCURLY_in_ignore_block2623 = new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L,0x0000000000000007L});
    public static final BitSet FOLLOW_ignore_block_body_in_ignore_block2625 = new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L,0x0000000000000007L});
    public static final BitSet FOLLOW_RIGHTCURLY_in_ignore_block2628 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ignore_block_in_ignore_block_body2656 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_ignore_block_body2666 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LEFTCURLY_in_synpred1_ProtoParser2652 = new BitSet(new long[]{0x0000000000000002L});
